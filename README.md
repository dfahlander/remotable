...
3. @Remotable() may be used with or without arbritary arguments `@Remotable(arg1, arg2, ...)`. Any arguments passed to the decorator will be forwarded to  Remotable.onproxy(_class, _function, ...decoratorArgs).
